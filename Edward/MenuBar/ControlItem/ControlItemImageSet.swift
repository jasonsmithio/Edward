...
extension ControlItemImageSet {
    /// The default image set for the Edward icon.
    static let defaultIceIcon = ControlItemImageSet(
        name: .martini,
        hidden: .catalog("MartiniFill"),
        visible: .catalog("MartiniStroke")
    )

    /// The image sets that the user can choose to display in the Edward icon.
