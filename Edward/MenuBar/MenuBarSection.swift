...
final class MenuBarSection {
    ...
    /// A Boolean value that indicates whether the Edward Bar should be used.
    ...
    func show() {
        ...
        if useIceBar {
            ...
            // Still update the visible control item (Edward icon) state to show
            // its alternate icon.
        ...
        // If we made it here, we're not using the Edward Bar.
    ...
    func hide() {
        ...
        menuBarManager.iceBarPanel.close() // Make sure Edward Bar is always closed.
