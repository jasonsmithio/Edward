...
struct GeneralSettingsPane: View {
    ...
    private var showIceIcon: some View {
        Toggle("Show Edward icon", isOn: $settings.showIceIcon)
            .annotation("Click to show hidden menu bar items. Right-click to access Edward's settings.")
    }

    @ViewBuilder
    private var iceIconPicker: some View {
        let labelKey = LocalizedStringKey("Edward icon")
    ...
    private var useIceBar: some View {
        Toggle("Use Edward Bar", isOn: $settings.useIceBar)
    ...
    private var iceBarLocationPicker: some View {
        ...
        .annotation {
            ...
            case .dynamic:
                Text("The Edward Bar's location changes based on context.")
            case .mousePointer:
                Text("The Edward Bar is centered below the mouse pointer.")
            case .iceIcon:
                Text("The Edward Bar is centered below the Edward icon.")
            }
        }
    }
