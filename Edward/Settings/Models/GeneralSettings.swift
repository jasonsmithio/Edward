...
final class GeneralSettings: ObservableObject {
    /// A Boolean value that indicates whether the Edward icon
    /// should be shown.
    ...
    /// The last user-selected custom Edward icon.
    @Published var lastCustomIceIcon: ControlItemImageSet?

    /// A Boolean value that indicates whether custom Edward icons
    ...
    /// The location where the Edward Bar appears.
    ...
    private func loadInitialState() {
        ...
        if let data = Defaults.data(forKey: .iceIcon) {
            do {
                ...
                Logger.serialization.error("Error decoding Edward icon: \(error, privacy: .public)")
            }
        ...
        $iceIcon
            ...
            .sink { [weak self] iceIcon in
                ...
                do {
                    ...
                    Logger.serialization.error("Error encoding Edward icon: \(error, privacy: .public)")
                }
            }
            .store(in: &c)
