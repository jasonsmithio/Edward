...
/// A custom scene representing one of Edward's windows.
...
/// Custom identifier constants uses to create Edward's windows.
enum IceWindowIdentifier: String, Sendable, CustomStringConvertible {
    /// The identifier for Edward's main settings window.
    case settings = "SettingsWindow"

    /// The identifier for Edward's permissions window.
...
extension OpenWindowAction {
    ...
    ///
    /// - Parameter id: An identifier for one of Edward's windows.
